    ...
    public abstract class GraphQLPaginationTestBase : SqlTestBase
    {
        ...
        public async Task RequestFullConnection()
        {
            ...
            string expected = @"{
              ...
              ""endCursor"": """ + SqlPaginationUtil.Base64Encode("{\"id\":[3,0]}") + @""",
              ""hasNextPage"": true
            }";
        ...
        public async Task RequestNoParamFullConnection()
        {
            ...
            string expected = @"{
              ...
              ""endCursor"": """ + SqlPaginationUtil.Base64Encode("{\"id\":[8,0]}") + @""",
              ""hasNextPage"": false
            }";
        ...
        {
            string graphQLQueryName = "books";
            string after = SqlPaginationUtil.Base64Encode("{ \"id\": [1000000,0] }");
            string graphQLQuery = @"{
                 books(first: 2," + $"after: \"{after}\")" + @"{
                    items {
                        title
              ...
              ""items"": [
                {
                  ...
                  ""publisher"": {
                    ...
                    ""paginatedBooks"": {
                      ...
                      ""endCursor"": """ + SqlPaginationUtil.Base64Encode("{\"id\":[2,0]}") + @""",
                      ""hasNextPage"": false
                    }
                  }
                },
                {
                  ...
                  ""publisher"": {
                    ...
                    ""paginatedBooks"": {
                      ...
                      ""endCursor"": """ + SqlPaginationUtil.Base64Encode("{\"id\":[4,0]}") + @""",
                      ""hasNextPage"": false
                    }
                  }
                }
            ...
            string expected = @"{
              ""publisher"": {
                ""paginatedBooks"": {
                  ...
                  ""endCursor"": """ + SqlPaginationUtil.Base64Encode("{\"id\":[5001,0]}") + @""",
                  ""hasNextPage"": false
                }
              }
            }";
                        ...
                        ""items"": [
                          {
                            ...
                            ""paginatedReviews"": {
                              ...
                              ""endCursor"": """ + SqlPaginationUtil.Base64Encode("{\"book_id\":[1,0],\"id\":[568,0]}") + @""",
                              ""hasNextPage"": true
                            }
                          },
                          {
        ...
        public async Task PaginateCompositePkTable()
        {
            ...
            string after = SqlPaginationUtil.Base64Encode("{\"book_id\":[1,0],\"id\":[567,0]}");
            string graphQLQuery = @"{
            ...
            string expected = @"{
              ...
              ""hasNextPage"": false,
              ""endCursor"": """ + SqlPaginationUtil.Base64Encode("{\"book_id\":[1,0],\"id\":[569,0]}") + @"""
            }";
