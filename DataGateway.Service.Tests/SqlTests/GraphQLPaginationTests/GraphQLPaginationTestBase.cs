...
namespace Azure.DataGateway.Service.Tests.SqlTests.GraphQLPaginationTests
{
    ...
    public abstract class GraphQLPaginationTestBase : SqlTestBase
    {
        ...
        public async Task RequestAfterTokenOnly()
        {
            ...
            JsonElement root = await ExecuteGraphQLRequestAsync(graphQLQuery, graphQLQueryName, false);
        ...
        public async Task RequestPaginatedQueryFromMutationResult()
        {
            ...
            ";
            JsonElement actual = await ExecuteGraphQLRequestAsync(graphQLMutation, graphQLMutationName, true);
            string expected = @"{
              ""publishers"": {
                ""books"": {
                  ""items"": [
            ...
            string expected = @"
{
  ...
  ""endCursor"": """ + SqlPaginationUtil.Base64Encode("[{\"Value\":2,\"Direction\":0,\"TableSchema\":\"\",\"TableName\":\"\",\"ColumnName\":\"id\"}]") + @"""
        ...
        public async Task TestCallingPaginationTwiceWithOrderBy()
        {
            ...
            JsonElement actual1 = await ExecuteGraphQLRequestAsync(graphQLQuery1, graphQLQueryName, false);
            ...
            JsonElement actual2 = await ExecuteGraphQLRequestAsync(graphQLQuery2, graphQLQueryName, false);
