...
namespace Azure.DataGateway.Service.Tests.SqlTests.GraphQLQueryTests
{
    ...
    public abstract class GraphQLQueryTestBase : SqlTestBase
    {
        ...
        public async Task MultipleResultQueryWithVariables(string dbQuery)
        {
            ...
            JsonElement actual = await GetGraphQLResultAsync(graphQLQuery, graphQLQueryName, new() { { "first", 100 } });
            string expected = await GetDatabaseResultAsync(dbQuery);
...
},
  {
    ...
    ""authors"": {
        ...
        public async Task OneToOneJoinQuery(string dbQuery)
        {
            ...
            JsonElement actual = await base.GetGraphQLResultAsync(graphQLQuery, graphQLQueryName);
            string expected = await GetDatabaseResultAsync(dbQuery);
        ...
        public virtual async Task DeeplyNestedManyToOneJoinQuery()
        {
            ...
            await this.GetGraphQLResultAsync(graphQLQuery, graphQLQueryName);
        }
            ...
            string graphQLQuery = @"
{
    books(first: 100) {
        ...
        public async Task QueryWithSingleColumnPrimaryKey(string dbQuery)
        {
            ...
            JsonElement actual = await base.GetGraphQLResultAsync(
...
},
  {
    ...
    ""publishers"": {
        ...
        public virtual async Task TestInvalidFirstParamQuery()
        {
            ...
            JsonElement result = await GetGraphQLResultAsync(graphQLQuery, graphQLQueryName);
