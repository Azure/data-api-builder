...
using Azure.DataGateway.Service.Exceptions;using Azure.DataGateway.Service.Controllers;
...
namespace Azure.DataGateway.Service.Tests.SqlTests.GraphQLQueryTests
{
    ...
    public class MsSqlGraphQLQueryTests : GraphQLQueryTestBase
    {
        ...
        public async Task TestSettingOrderByOrderUsingVariable()
        {
            ...
            string msSqlQuery = $"SELECT TOP 100 id, title FROM books ORDER BY id DESC FOR JSON PATH, INCLUDE_NULL_VALUES";
