...
namespace Azure.DataGateway.Service.Tests.SqlTests
{
    ...
    public abstract class RestApiTestBase : SqlTestBase
    {
        ...
        /// </summary>
        [TestMethod]
        public virtual async Task InsertOneWithPrimaryKeyInJsonBodyTest()
        {
            string requestBody = @"
            {
        ...
        /// <summary>
        /// Tests the InsertOne functionality with an invalid field in the request body:
        /// Primary Key in the request body for table without Auto Generated PK.
        /// </summary>
        [TestMethod]
        public virtual async Task InsertOneWithNonAutoGeneratedPrimaryKeyInJsonBodyTest()
        {
            string requestBody = @"
            {
                ""id"": " + STARTING_ID_FOR_TEST_INSERTS +
