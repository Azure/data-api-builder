...
namespace Azure.DataGateway.Service.Tests.SqlTests
{
    ...
    public abstract class RestApiTestBase : SqlTestBase
    {
        ...
        public virtual async Task InsertOneInCompositeKeyTableTest()
        {
            ...
            expectedLocationHeader = $"book_id/2/id/{STARTING_ID_FOR_TEST_INSERTS}";
            await SetupAndRunRestApiTest(
                primaryKeyRoute: null,
                queryString: null,
        ...
        public virtual async Task PutOne_Update_Test()
        {
            ...
            string expectedLocationHeader = $"book_id/1/id/1";
            await SetupAndRunRestApiTest(
        ...
        public virtual async Task PutOne_Insert_Test()
        {
            ...
            await SetupAndRunRestApiTest(
                ...
                sqlQuery: GetQuery("PutOne_Update_NonAutoGenPK_Test"),
                controller: _restController,
                operationType: Operation.Upsert,
                requestBody: requestBody,
                expectedStatusCode: HttpStatusCode.Created,
        ...
        public virtual async Task PatchOne_Update_Test()
        {
            ...
            await SetupAndRunRestApiTest(
                    primaryKeyRoute: "id/1/book_id/1",
                    queryString: null,
                    entity: _DefaultTestTable,
