...
namespace Azure.DataGateway.Service.Tests.SqlTests
{
    ...
    public abstract class RestApiTestBase : SqlTestBase
    {
        ...
        public virtual async Task PutOne_Insert_Test()
        {
            ...
            // The request body doesn't contain a nullable, with no default,
            // non-autogenerated field. It should result in a successful insert.
            string requestBody = @"
            {
                ""title"": ""Times""
            }";

            string expectedLocationHeader = $"id/{STARTING_ID_FOR_TEST_INSERTS + 1}";
            await SetupAndRunRestApiTest(
                primaryKeyRoute: expectedLocationHeader,
                queryString: null,
                entity: _integration_NonAutoGenPK_TableName,
            ...
            // The request body doesn't contain a non-nullable
            // autogenerated field that is not a primary key.
