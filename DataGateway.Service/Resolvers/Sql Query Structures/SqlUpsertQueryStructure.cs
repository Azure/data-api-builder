...
namespace Azure.DataGateway.Service.Resolvers
{
    ...
    public class SqlUpsertQueryStructure : BaseSqlQueryStructure
    {
        ...
        private void AddNullifiedUnspecifiedFields(List<string> leftoverSchemaColumns, TableDefinition tableDefinition)
        {
            ...
            {
                if (!tableDefinition.Columns[leftOverColumn].HasDefault)
                {
                    Predicate predicate = new(
                ...
                {
                    // Non Nullable columns must have a value defined in request as
                    // runtime does not determine a default value, as that may not
                    // be specifically desired by requestor.
                    throw new DatagatewayException(
                        message: "Request must define values for all required columns.",
                        statusCode: (int)HttpStatusCode.BadRequest,
                        subStatusCode: DatagatewayException.SubStatusCodes.BadRequest);
                }
