...
namespace Azure.DataGateway.Service.Resolvers
{
    ...
    public class SqlUpsertQueryStructure : BaseSqlQueryStructure
    {
        ...
        /// <summary>
        /// Keep this for create insert and update structure
        /// </summary>
        private IDictionary<string, object> MutationParams { get; }
        ...
        public SqlInsertStructure CreateInsertStructure() {
            return new SqlInsertStructure(
                this.TableName,
                this.MetadataStoreProvider,
                this.MutationParams);
        }

        public SqlUpdateStructure CreateUpdateStructure() {
