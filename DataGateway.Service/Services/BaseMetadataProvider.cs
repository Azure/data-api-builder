...
namespace Azure.DataGateway.Service.Services
{
    ...
    public class BaseMetadataProvider : IMetadataStoreProvider
    {
        ...
        public BaseMetadataProvider(string resolverConfig, DatabaseType databaseType, string connectionString, string graphQLSchema = "")
        {
            ...
            if ((deserializedConfig = JsonSerializer.Deserialize<ResolverConfig>(resolverConfig, options)) == null)
            {
