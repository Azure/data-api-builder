    ...
    public class RequestValidator
    {
        ...
        IMetadataStoreProvider configurationProvider)
        {
            ...
            foreach (KeyValuePair<string, ColumnDefinition> column in tableDefinition.Columns)
            {
                ...
                if (// If the column value is not autogenerated and not nullable, then the body should contain that field.
                    ...
                    || //nullable non-autogen'd fields are allowed to be excluded from body -> OK to Validate for UPDATE.
