    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddGraphQLServer()
                .ConfigureSchema((IServiceProvider serviceProvicer, ISchemaBuilder schemaBuilder) =>
                {
                    GraphQLService gservice = serviceProvicer.GetRequiredService<GraphQLService>();
                    IQueryEngine qEng = serviceProvicer.GetRequiredService<IQueryEngine>();
                    IMutationEngine mEng = serviceProvicer.GetRequiredService<IMutationEngine>();
                    schemaBuilder
                        .AddDocument(gservice.RootDocNode)
                        .AddDocument(gservice.QueryDocNode)
                        .AddDocument(gservice.MutationDocNode)
