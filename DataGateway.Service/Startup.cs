...
namespace Azure.DataGateway.Service
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //services.Configure(Schema.DefaultName, (RequestExecutorSetup o) => o.Schema = Schema);
            services.AddGraphQLServer()
                .RegisterService<IAuthorizationResolver>()
                //.RegisterService<GraphQLService>()
                .ConfigureSchema((sp,sb) => {
                    GraphQLService gservice = sp.GetRequiredService<GraphQLService>();
                    IQueryEngine qEng = sp.GetRequiredService<IQueryEngine>();
                    IMutationEngine mEng = sp.GetRequiredService<IMutationEngine>();
                    sb
                    .AddDocument(gservice.RootDocNode)
                    ...
                    .Use((services, next) => new ResolverMiddleware(next, qEng, mEng));
                    //sb.SetSchema(gservice.SchemaBuilderObj.Create());
                })
                .AddAuthorization()
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, RuntimeConfigProvider runtimeConfigProvider)
        {
            ...
            app.UseEndpoints(endpoints =>
            {
                ...
                //endpoints.MapBananaCakePop(toolPath: "/graphqlbcp");
            });
        }
