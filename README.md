...
Latest stable version of Data API builder is **0.6.14** [What's new?](https://learn.microsoft.com/azure/data-api-builder/whats-new). The latest pre-release version is 0.7.6.
