...
There are several ways to get an Azure MySQL Database connection string. See [how to connect and query with MySQL](https://learn.microsoft.com/en-us/azure/mysql/flexible-server/connect-csharp).
