...
public static class DmlTools
{
        ...
        string[]? entityNames = null)
    {
        ...
        activity.SetTag("tool", nameof(ListEntitiesAsync));
    ...
    [McpServerTool, Description("Do not use this as it is not functional.")]
    public static Task<string> ReadEntityRecordsAsync() => throw new NotImplementedException();

    [McpServerTool, Description("Do not use this as it is not functional.")]
    public static Task<string> UpdateEntityRecordAsync() => throw new NotImplementedException();

    [McpServerTool, Description("Do not use this as it is not functional.")]
    public static Task<string> DeleteEntityRecordAsync() => throw new NotImplementedException();
