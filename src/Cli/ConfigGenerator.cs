...
#pragma warning restore CS8618
        ...
        public static bool TryStartEngineWithOptions(StartOptions options, FileSystemRuntimeConfigLoader loader, IFileSystem fileSystem)
        {
            ...
            if (options.LogLevel is not null)
            {
                ...
                {
                    _logger.LogError(
                        "LogLevel's valid range is 0 to 6, your value: {logLevel}, see: https://learn.microsoft.com/dotnet/api/microsoft.extensions.logging.loglevel?view=dotnet-plat-ext-8.0",
                        options.LogLevel);
                    return false;
                }
