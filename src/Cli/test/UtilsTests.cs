namespace Cli.Tests
{
    ...
    public class UtilsTests
    {
        ...
        /// </summary>
        [DataTestMethod]
        [DataRow("StaticWebApps", "aud-xxx", "issuer-xxx", false, DisplayName = "FAIL: StaticWebApps incorrectly configured with audience and issuer.")]
        [DataRow("StaticWebApps", null, "issuer-xxx", false, DisplayName = "FAIL: StaticWebApps incorrectly configured with issuer.")]
        [DataRow("StaticWebApps", "aud-xxx", null, false, DisplayName = "FAIL: StaticWebApps incorrectly configured with audience.")]
        ...
        [DataRow("AppService", "aud-xxx", "issuer-xxx", false, DisplayName = "FAIL: AppService incorrectly configured with audience and issuer.")]
        [DataRow("AppService", null, "issuer-xxx", false, DisplayName = "FAIL: AppService incorrectly configured with issuer.")]
        [DataRow("AppService", "aud-xxx", null, false, DisplayName = "FAIL: AppService incorrectly configured with audience.")]
        [DataRow("AppService", null, null, true, DisplayName = "PASS: AppService correctly configured with neither audience nor issuer.")]
        [DataRow("Simulator", "aud-xxx", "issuer-xxx", false, DisplayName = "FAIL: Simulator incorrectly configured with audience and issuer.")]
        [DataRow("Simulator", null, "issuer-xxx", false, DisplayName = "FAIL: Simulator incorrectly configured with issuer.")]
        [DataRow("Simulator", "aud-xxx", null, false, DisplayName = "FAIL: Simulator incorrectly configured with audience.")]
