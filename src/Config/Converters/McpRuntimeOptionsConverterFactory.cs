...
internal class McpRuntimeOptionsConverterFactory : JsonConverterFactory
{
    ...
    private class McpRuntimeOptionsConverter : JsonConverter<McpRuntimeOptions>
    {
            ...
            if (reader.TokenType is JsonTokenType.StartObject)
            {
                ...
                while (reader.Read())
                {
                    ...
                    switch (propertyName)
                    {
                        ...
                        case "dml-tools":
                            dmlTools = dmlToolsOptionsConverter.Read(ref reader, typeToConvert, options);
                            break;
        ...
        public override void Write(Utf8JsonWriter writer, McpRuntimeOptions value, JsonSerializerOptions options)
        {
            ...
            {
                McpDmlToolsOptionsConverter dmlToolsOptionsConverter = options.GetConverter(typeof(McpDmlToolsOptions)) as McpDmlToolsOptionsConverter ??
