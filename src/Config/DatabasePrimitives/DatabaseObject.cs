...
public class ParameterDefinition
{
    ...
    {
        return other is not null &&
               HasConfigDefault.Equals(other.HasConfigDefault) &&
               SystemType.Equals(other.SystemType) &&
               ((DbType == null && other.DbType == null) || DbType?.Equals(other.DbType) == true) &&
               ((ConfigDefaultValue == null && other.ConfigDefaultValue == null) || ConfigDefaultValue?.Equals(other.ConfigDefaultValue) == true);
    }
}
...
public class ColumnDefinition
{
    ...
    public bool Equals(ColumnDefinition other)
    {
        return other is not null &&
               ...
               IsAutoGenerated.Equals(other.IsAutoGenerated) &&
               IsNullable.Equals(other.IsNullable) &&
               IsReadOnly.Equals(other.IsReadOnly) &&
               SystemType.Equals(other.SystemType) &&
               ((DbType == null && other.DbType == null) || DbType?.Equals(other.DbType) == true) &&
               ((DefaultValue == null && other.DefaultValue == null) || DefaultValue?.Equals(other.DefaultValue) == true);
    }
}
