...
namespace Azure.DataApiBuilder.Config.ObjectModel
{
    ...
    public static class AutoEmbedDescription
    {
        ...
        /// </remarks>
        internal const string Suffix = " (auto-embed: DAB converts this value to an embedding before execution)";

        /// <summary>
        /// Appends <see cref="Suffix"/> to <paramref name="baseDescription"/> when
        ...
        public static string? Append(string? baseDescription, bool isAutoEmbed) =>
            isAutoEmbed ? (baseDescription ?? string.Empty) + Suffix : baseDescription;
    }
}
