...
/// <param name="Subscription">GraphQL subscription settings for the entity.</param>
/// <seealso cref="https://engdic.org/singular-and-plural-noun-rules-definitions-examples"/>
public record EntityGraphQLOptions(string Singular, string Plural, bool Enabled = true, GraphQLOperation? Operation = null, EntityGraphQLSubscriptionOptions? Subscription = null);
