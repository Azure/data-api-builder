...
namespace Azure.DataApiBuilder.Core.Parsers
{
    ...
    public class ODataASTVisitorForCosmos : QueryNodeVisitor<string>
    {
        ...
        public override string Visit(SingleValuePropertyAccessNode nodeIn)
        {
            ...
            return $"{_sourceAlias}.{_metadataProvider.GetQueryBuilder().QuoteIdentifier(backingColumnName!)}";
        }
        ...
        public override string Visit(ConstantNode nodeIn)
        {
            ...
            return $"{MakeDbConnectionParam(GetParamWithSystemType(nodeIn.Value.ToString()!, nodeIn.TypeReference))}";
        }
