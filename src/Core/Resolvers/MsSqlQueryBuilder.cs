    ...
    public class MsSqlQueryBuilder : BaseSqlQueryBuilder, IQueryBuilder
    {
        ...
        public string Build(SqlInsertStructure structure)
        {
            ...
            else
            {
                ...
                // Hence in the select query, we will add an additional WHERE predicate (alongwith the join) which compares value of autogenerated PK column
                // in the actual and the temporary table. It is to be noted that MsSql supports only one IDENTITY/autogenerated column per table.
