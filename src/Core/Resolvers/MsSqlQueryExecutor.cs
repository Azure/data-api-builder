...
namespace Azure.DataApiBuilder.Core.Resolvers
{
    ...
    public class MsSqlQueryExecutor : QueryExecutor<SqlConnection>
    {
                  ...
                  httpContextAccessor)
        {
            ...
            IEnumerable<KeyValuePair<string, DataSource>> mssqldbs = runtimeConfig.GetDataSourceNamesToDataSourcesIterator().Where(x => x.Value.DatabaseType == DatabaseType.MSSQL || x.Value.DatabaseType == DatabaseType.DWSQL);
