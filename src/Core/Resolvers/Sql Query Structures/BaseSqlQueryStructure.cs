...
namespace Azure.DataApiBuilder.Core.Resolvers
{
    ...
    public abstract class BaseSqlQueryStructure : BaseQueryStructure
    {
            ...
            SourceDefinition sourceDefinition)
        {
            ...
            {
                // If the left over column is autogenerated or is a read-only column,
                // then no need to add it with a null value.
                if (sourceDefinition.Columns[leftoverColumn].IsAutoGenerated || sourceDefinition.Columns[leftoverColumn].IsReadOnly)
                {
                    continue;
                }
