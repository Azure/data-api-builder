    ...
    public class GraphQLSchemaCreator
    {
            ...
            Dictionary<string, InputObjectTypeDefinitionNode> inputTypes)
        {
            ...
            return sb
                ...
                .AddDirectiveType<MeasureDirectiveType>()
            ...
            foreach ((string entityName, Entity entity) in runtimeConfig.Entities)
            {
                ...
                switch (ds.DatabaseType)
                {
                    ...
                    case DatabaseType.SemanticModel:
                        // Semantic models are read-only; entities are added to sqlEntities
                        // for GraphQL schema generation (queries only, no mutations).
                        sqlEntities.TryAdd(entityName, entity);
                        break;
                    default:
