...
namespace Azure.DataApiBuilder.Core.Services
{
    ...
    public class OpenApiDocumentor : IOpenApiDocumentor
    {
        ...
        public void Documentor_ConfigChangeEventReceived(object? sender, CustomEventArgs args)
        {
            ...
            Console.ResetColor();
            CreateDocument(isHotReloadScenario: true, isNewConfigDetected: true, isNewConfigValidated: false);
        }
        ...
        public void CreateDocument(bool isHotReloadScenario = false, bool isNewConfigDetected = false, bool isNewConfigValidated = true)
        {
            RuntimeConfig runtimeConfig = _runtimeConfigProvider.GetConfig(isNewConfigDetected, isNewConfigValidated);
