...
namespace Azure.DataApiBuilder.Core.Telemetry.Product
{
    ...
    /// </summary>
    internal sealed class EngineTelemetryDelivery : IDisposable
    {
        private static readonly TimeSpan _maximumFlushTimeout = TimeSpan.FromSeconds(2);
        private readonly object _sync = new();
        private readonly Func<IEngineTelemetryExporter> _factory;
        private readonly Channel<EngineTelemetryEvent> _queue;
        ...
        private IEngineTelemetryExporter? _exporter;
        private EngineTelemetryEvent? _inFlight;
            ...
            TimeProvider timeProvider)
        {
            ...
            _cancellation = new();
            _queue = Channel.CreateBounded<EngineTelemetryEvent>(new BoundedChannelOptions(capacity)
            {
        ...
        /// </summary>
        public bool TryEnqueue(EngineTelemetryEvent record)
        {
        ...
        private async Task<bool> ExportWithRetriesAsync(EngineTelemetryEvent record)
        {
