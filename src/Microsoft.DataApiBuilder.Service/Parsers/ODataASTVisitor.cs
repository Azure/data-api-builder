...
namespace Microsoft.DataApiBuilder.Service.Parsers
{
    /// <summary>
    ...
    public class ODataASTVisitor : QueryNodeVisitor<string>
    {
        ...
        public ODataASTVisitor(BaseSqlQueryStructure structure, ISqlMetadataProvider metadataProvider, Operation operation = Operation.None)
        {
            _struct = structure;
        ...
        public override string Visit(SingleValuePropertyAccessNode nodeIn)
        {
            ...
            if (_operation is Operation.Create)
            {
