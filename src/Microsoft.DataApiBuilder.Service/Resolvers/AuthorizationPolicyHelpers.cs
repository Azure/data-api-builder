...
namespace Microsoft.DataApiBuilder.Service.Resolvers
{
    ...
    public static class AuthorizationPolicyHelpers
    {
            ...
            ISqlMetadataProvider sqlMetadataProvider)
        {
            ...
            List<Operation> elementalOperations = ResolveCompoundOperationToElementalOperations(operation);

            foreach (Operation elementalOperation in elementalOperations)
            {
        ...
        private static List<Operation> ResolveCompoundOperationToElementalOperations(Operation operation)
        {
            switch (operation)
            {
                case Operation.Upsert:
                case Operation.UpsertIncremental:
                    return new List<Operation> { Operation.Update, Operation.Create };
                default:
                    return new List<Operation> { operation };
            }
        }
    }
}
