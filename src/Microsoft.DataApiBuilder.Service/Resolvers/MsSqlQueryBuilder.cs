...
namespace Microsoft.DataApiBuilder.Service.Resolvers
{
    /// <summary>
    ...
    public class MsSqlQueryBuilder : BaseSqlQueryBuilder, IQueryBuilder
    {
        ...
        public string Build(SqlQueryStructure structure)
        {
            ...
            string predicates = JoinPredicateStrings(
                                    structure.GetDbPolicyForOperation(Operation.Read),
        ...
        {
            string predicates = JoinPredicateStrings(structure.GetDbPolicyForOperation(Operation.Create));
        ...
        {
            string predicates = JoinPredicateStrings(
                                   structure.GetDbPolicyForOperation(Operation.Update),
                                   Build(structure.Predicates));
        ...
        {
            string predicates = JoinPredicateStrings(
                       structure.GetDbPolicyForOperation(Operation.Delete),
                       Build(structure.Predicates));
        ...
        public string Build(SqlUpsertQueryStructure structure)
        {
            ...
            string updatePredicates = JoinPredicateStrings(pkPredicates, structure.GetDbPolicyForOperation(Operation.Update));
            ...
            if (!structure.IsFallbackToUpdate)
            {
                ...
                string createPredicates = JoinPredicateStrings(structure.GetDbPolicyForOperation(Operation.Create));
