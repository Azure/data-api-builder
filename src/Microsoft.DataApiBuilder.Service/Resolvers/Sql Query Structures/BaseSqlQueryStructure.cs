...
namespace Microsoft.DataApiBuilder.Service.Resolvers
{
    ...
    public abstract class BaseSqlQueryStructure : BaseQueryStructure
    {
        ...
        /// </summary>
        public Dictionary<Operation, string?> DbPolicyPredicatesForOperations { get; set; } = new();
        ...
        public void ProcessOdataClause(FilterClause? dbPolicyClause, Operation operation)
        {
        ...
        public string? GetDbPolicyForOperation(Operation operation)
        {
