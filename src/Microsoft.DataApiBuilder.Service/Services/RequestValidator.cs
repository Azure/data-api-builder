...
namespace Microsoft.DataApiBuilder.Service.Services
{
    /// <summary>
    ...
    public class RequestValidator
    {
        ...
        public static void ValidatePrimaryKeyRouteAndQueryStringInURL(Operation operationType, string? primaryKeyRoute = null, string? queryString = null)
        {
