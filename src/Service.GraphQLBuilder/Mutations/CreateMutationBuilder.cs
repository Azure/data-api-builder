...
namespace Azure.DataApiBuilder.Service.GraphQLBuilder.Mutations
{
    public static class CreateMutationBuilder
    {
        ...
        private static InputObjectTypeDefinitionNode GenerateCreateInputTypeForRelationalDb(
            ...
            bool IsMultipleCreateOperationSupportedAndEnabled)
        {
            ...
            IEnumerable<InputValueDefinitionNode> scalarInputFields = objectTypeDefinitionNode.Fields
                ...
                .Select(field =>
                {
                    return GenerateScalarInputType(name, field, IsMultipleCreateOperationSupportedAndEnabled);
                });
            ...
            if (IsMultipleCreateOperationSupportedAndEnabled)
            {
                    ...
                    .Select(field =>
                    {
                        ...
                        if (IsMToNRelationship(entity, field.Name.Value))
                        {
                            ...
                            return GenerateComplexInputTypeForRelationalDb(
                                ...
                                databaseType: databaseType,
                                entities: entities,
                                IsMultipleCreateOperationSupportedAndEnabled: IsMultipleCreateOperationSupportedAndEnabled);
                        }
        ...
        /// <param name="IsMultipleCreateOperationSupportedAndEnabled">Indicates whether multiple create operation is enabled</param>
        private static InputValueDefinitionNode GenerateScalarInputType(NameNode name, FieldDefinitionNode fieldDefinition, bool isMultipleCreateOperationSupportedAndEnabled = false)
        {
            ...
            bool IsMultipleCreateOperationSupportedAndEnabled)
        {
            ...
            return GetComplexInputType(field, node, inputTypeName, IsMultipleCreateOperationSupportedAndEnabled);
        }
            ...
            DatabaseType databaseType)
        {
            ...
            // For non-relational databases, multiple create operation is not supported. Hence, IsMultipleCreateOperationSupportedAndEnabled parameter is set to false.
            return GetComplexInputType(field, node, inputTypeName, IsMultipleCreateOperationSupportedAndEnabled: false);
        }
        ...
        /// <param name="IsMultipleCreateOperationSupportedAndEnabled">Indicates whether multiple create operation is supported by the database type and is enabled through config file</param>
        /// <returns></returns>
