    ...
    public static class CreateMutationBuilder
    {
            ...
            bool isMultipleCreateOperationEnabled = false)
        {
            ...
            IEnumerable<InputValueDefinitionNode> scalarInputFields = objectTypeDefinitionNode.Fields
                ...
                .Select(field =>
                {
                    return GenerateScalarInputType(name, field, databaseType, isMultipleCreateOperationEnabled);
                });
        ...
        private static bool IsComplexFieldAllowedForCreateInputInRelationalDb(FieldDefinitionNode field, DatabaseType databaseType, IEnumerable<HotChocolate.Language.IHasName> definitions)
        {
        ...
        private static InputValueDefinitionNode GenerateScalarInputType(NameNode name, FieldDefinitionNode fieldDefinition, DatabaseType databaseType, bool isMultipleCreateOperationEnabled = false)
        {
            ...
            if (isMultipleCreateOperationEnabled &&
              (IsRelationalDb(databaseType) &&
               DoesRelationalDBSupportMultipleCreate(databaseType) &&
