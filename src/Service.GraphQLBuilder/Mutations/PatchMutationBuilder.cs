...
{
    public static class PatchMutationBuilder
    {
        public const string INPUT_ARGUMENT_NAME = "item";

        /// <summary>
        /// This method is used to determine if a field is allowed to be sent from the client in a Patch mutation (eg, id field is not settable during update).
        /// </summary>
        ...
        private static bool FieldAllowedOnPatchInput(FieldDefinitionNode field, DatabaseType databaseType, IEnumerable<HotChocolate.Language.IHasName> definitions)
        {
        ...
        private static InputObjectTypeDefinitionNode GeneratePatchInputType(
            ...
            DatabaseType databaseType)
        {
            ...
            IEnumerable<InputValueDefinitionNode> inputFields =
                ...
                .Where(f => FieldAllowedOnPatchInput(f, databaseType, definitions))
                .Select(f =>
                {
        ...
        private static InputValueDefinitionNode GenerateSimpleInputType(NameNode name, FieldDefinitionNode f, DatabaseType databaseType)
        {
            return new(
                ...
                /// Cosmos is calling replace item whereas for sql is doing incremental patch.
                /// That's why sql allows nullable patch input fields even for non-nullable simple fields. 
            ...
            DatabaseType databaseType)
        {
            ...
            {
                node = GeneratePatchInputType(inputs, otdn, f.Type.NamedType().Name, definitions, entities, databaseType);
            }
            else
            {
        ...
        /// <summary>
        /// Generates a string of the form "Patch{EntityName}Input"
        /// </summary>
        ...
        {
            return new($"{EntityActionOperation.Patch}{typeName}Input");
        }

        /// <summary>
        /// Generate the <c>patch</c> field for the GraphQL mutations for a given object type.
        ...
        /// <param name="objectTypeDefinitionNode">GraphQL object to create the patch field for.</param>
        ...
        /// <returns>A <c>patch*ObjectName*</c> field to be added to the Mutation type.</returns>
        ...
        {
            InputObjectTypeDefinitionNode input = GeneratePatchInputType(
                inputs,
            ...
            return new(
                location: null,
                new NameNode($"patch{singularName}"),
                new StringValueNode($"Patches a {singularName}"),
                inputValues,
