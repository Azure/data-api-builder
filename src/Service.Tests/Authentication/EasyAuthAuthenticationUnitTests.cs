...
namespace Azure.DataApiBuilder.Service.Tests.Authentication
{
    ...
    public class EasyAuthAuthenticationUnitTests
    {
        ...
        /// <seealso cref="https://learn.microsoft.com/en-us/dotnet/api/system.security.claims.claimsidentity.name?view=net-8.0"/>
        /// <seealso cref="https://learn.microsoft.com/en-us/dotnet/api/system.security.claims.claimsidentity.nameclaimtype?view=net-8.0"/>
        [DataTestMethod]
        ...
        /// <seealso cref="https://learn.microsoft.com/en-us/dotnet/api/system.security.claims.claimsidentity.roleclaimtype?view=net-8.0"/>
        /// <seealso cref="https://learn.microsoft.com/en-us/dotnet/api/system.security.claims.claimsprincipal.isinrole?view=net-8.0"/>
        [DataTestMethod]
        ...
        /// <seealso cref="https://docs.microsoft.com/dotnet/api/system.security.claims.claim.type?view=net-8.0"/>
        /// <seealso cref="https://docs.microsoft.com/dotnet/api/system.security.claims.claim.value?view=net-8.0"/>
        [DataTestMethod]
