...
namespace Azure.DataApiBuilder.Service.Tests.Authentication
{
    internal class AuthTestCertHelper
    {
        ...
        /// - Usage of RSASignaturePadding.Pss: https://docs.microsoft.com/dotnet/api/system.security.cryptography.rsasignaturepaddingmode?view=net-8.0#system-security-cryptography-rsasignaturepaddingmode-pss
        /// </summary>
