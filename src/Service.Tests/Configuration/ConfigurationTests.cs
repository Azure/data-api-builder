...
namespace Azure.DataApiBuilder.Service.Tests.Configuration
{
    ...
    : VerifyBase
    {
        ...
        [DataTestMethod]
        [DataRow(DatabaseType.MSSQL, "Something;", "Something;Application Name=dab_oss_1.0.0;", false, DisplayName = "[MSSQL]:Adding Application Name property to connectionString with dab_oss app name.")]
        ...
        [DataRow(DatabaseType.MSSQL, "Something;Application Name=CustAppName;", "Something;Application Name=CustAppName,dab_oss_1.0.0;", false, DisplayName = "[MSSQL]:Updating connectionString containing customer Application name with dab_oss app name.")]
        [DataRow(DatabaseType.MSSQL, "Something1;Application Name=CustAppName;Something2;", "Something1;Application Name=CustAppName,dab_oss_1.0.0;Something2;", false, DisplayName = "[MSSQL2]:Updating connectionString containing customer Application name with dab_oss app name.")]
        [DataRow(DatabaseType.MySQL, "Something;Application Name=CustAppName;", "Something;Application Name=CustAppName;", false, DisplayName = "[MYSQL]:No Change in connectionString containg customer Application name for DAB oss.")]
        [DataRow(DatabaseType.PostgreSQL, "Something;Application Name=CustAppName;", "Something;Application Name=CustAppName;", false, DisplayName = "[PGSQL]:No Change in connectionString containg customer Application name for DAB oss.")]
        [DataRow(DatabaseType.CosmosDB_PostgreSQL, "Something;Application Name=CustAppName;", "Something;Application Name=CustAppName;", false, DisplayName = "[COSMOSDB_PGSQL]:No Change in connectionString containg customer Application name for DAB oss.")]
        ...
        [DataRow(DatabaseType.MSSQL, "Something;", "Something;Application Name=dab_hosted_1.0.0;", true, DisplayName = "[MSSQL]:Adding Application Name property to connectionString with dab_hosted app.")]
        ...
        [DataRow(DatabaseType.MSSQL, "Something;Application Name=CustAppName;", "Something;Application Name=CustAppName,dab_hosted_1.0.0;", true, DisplayName = "[MSSQL]:Updating connectionString containing customer Application name with dab_hosted app name.")]
        [DataRow(DatabaseType.MySQL, "Something;Application Name=CustAppName;", "Something;Application Name=CustAppName;", true, DisplayName = "[MYSQL]:No Change in connectionString containg customer Application name for DAB hosted.")]
        [DataRow(DatabaseType.PostgreSQL, "Something;Application Name=CustAppName;", "Something;Application Name=CustAppName;", true, DisplayName = "[PGSQL]:No Change in connectionString containg customer Application name for DAB hosted.")]
