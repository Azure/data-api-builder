...
namespace Azure.DataApiBuilder.Service.Tests.GraphQLBuilder.Sql
{
    ...
    public class SchemaConverterTests
    {
        ...
        {
            DatabaseEntityDefinition table = new();
        ...
        {
            DatabaseEntityDefinition table = GenerateTableWithForeignKeyDefinition();
        ...
        {
            DatabaseEntityDefinition table = GenerateTableWithForeignKeyDefinition(isNullableRelationship);
        ...
        /// <returns></returns>
        private static DatabaseEntityDefinition GenerateTableWithForeignKeyDefinition(bool isNullable = false)
        {
            DatabaseEntityDefinition table = new();
