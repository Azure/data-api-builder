...
namespace Azure.DataApiBuilder.Service.Tests.GraphQLBuilder.Sql
{
    ...
    public class StoredProcedureBuilderTests
    {
        ...
        [DataTestMethod]
        [DataRow(typeof(byte), BYTE_TYPE, 64, DisplayName = "Byte")]
        [DataRow(typeof(short), SHORT_TYPE, 32767, DisplayName = "Short")]
        [DataRow(typeof(int), INT_TYPE, 2147483647, DisplayName = "Int")]
        [DataRow(typeof(long), LONG_TYPE, 9223372036854775807, DisplayName = "Long")]
        [DataRow(typeof(float), SINGLE_TYPE, 3.402823e38, DisplayName = "Single")]
        [DataRow(typeof(double), FLOAT_TYPE, "12.7", DisplayName = "Float")]
        [DataRow(typeof(decimal), DECIMAL_TYPE, "12.7", DisplayName = "Decimal")]
        [DataRow(typeof(string), STRING_TYPE, "paramValueconfig", DisplayName = "String")]
        [DataRow(typeof(bool), BOOLEAN_TYPE, true, DisplayName = "Bool")]
        [DataRow(typeof(DateTime), DATETIME_TYPE, "12/31/2030 12:00:00 AM", DisplayName = "DateTime")]
        [DataRow(typeof(byte[]), BYTEARRAY_TYPE, "AgQGCAoMDhASFA==", DisplayName = "Byte[]")]
