...
namespace Azure.DataApiBuilder.Service.Tests.Mcp
{
    ...
    {
        [TestMethod]
        public async Task InitializedClient_RefreshesRegistry_ReceivesNotificationAndUpdatedList()
        {
            ...
            Assert.AreEqual(4, shutdownResponse.RootElement.GetProperty("id").GetInt32());
            await serverTask;
        }
