...
namespace Azure.DataApiBuilder.Service.Tests.SqlTests.GraphQLSupportedTypesTests
{
    ...
    public abstract class GraphQLSupportedTypesTestBase : SqlTestBase
    {
        ...
        [DataTestMethod]
        [DataRow(BYTE_TYPE, 1, DisplayName = "Query by PK test selecting only byte_types.")]
        [DataRow(SHORT_TYPE, 2, DisplayName = "Query by PK test selecting only short_types.")]
        [DataRow(INT_TYPE, 3, DisplayName = "Query by PK test selecting only int_types.")]
        [DataRow(LONG_TYPE, 4, DisplayName = "Query by PK test selecting only long_types.")]
        [DataRow(SINGLE_TYPE, 1, DisplayName = "Query by PK test selecting only float_types.")]
        [DataRow(FLOAT_TYPE, 2, DisplayName = "Query by PK test selecting only byte_type.")]
        [DataRow(DECIMAL_TYPE, 3, DisplayName = "Query by PK test selecting only decimal_types")]
        [DataRow(STRING_TYPE, 4, DisplayName = "Query by PK test selecting only string_types.")]
        ...
        [DataRow(BYTEARRAY_TYPE, 3, DisplayName = "Query by PK test selecting only bytearray_types.")]
        [DataRow(GUID_TYPE, 4, DisplayName = "Query by PK test selecting only guid_types.")]
