...
namespace Azure.DataApiBuilder.Service.Tests.SqlTests.GraphQLSupportedTypesTests
{
    ...
    public abstract class GraphQLSupportedTypesTestBase : SqlTestBase
    {
        ...
        [DataRow(FLOAT_TYPE, 1, DisplayName = "Query by PK test selecting only byte_type with typeid = 1.")]
        [DataRow(FLOAT_TYPE, 2, DisplayName = "Query by PK test selecting only byte_type with typeid = 2.")]
        [DataRow(FLOAT_TYPE, 3, DisplayName = "Query by PK test selecting only byte_type with typeid = 3.")]
        [DataRow(FLOAT_TYPE, 4, DisplayName = "Query by PK test selecting only byte_type with typeid = 4.")]
