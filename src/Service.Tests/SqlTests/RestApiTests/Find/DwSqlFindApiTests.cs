...
namespace Azure.DataApiBuilder.Service.Tests.SqlTests.RestApiTests.Find
{
    ...
    public class DwSqlFindApiTests : FindApiTestBase
    {
        ...
        private static Dictionary<string, string> _queryMap = new()
        {
            ...
            },
            {
                ...
                $"WHERE [pieceid] = 1 " +
                $"ORDER BY {_simple_subset_stocks}.[categoryid] ASC, {_simple_subset_stocks}.[pieceid] ASC "+
                $"FOR JSON PATH, INCLUDE_NULL_VALUES"
            },
            {
            ...
            },
            {
                ...
                $"SELECT [categoryid], [categoryName] FROM {_Composite_NonAutoGenPK_TableName} " +
                $"ORDER BY {_Composite_NonAutoGenPK_TableName}.[categoryid] ASC, {_Composite_NonAutoGenPK_TableName}.[pieceid] ASC "+
                $"FOR JSON PATH, INCLUDE_NULL_VALUES"
            },
            {
