...
namespace Azure.DataApiBuilder.Service.Tests.UnitTests
{
    ...
    public class SqlMetadataProviderUnitTests : SqlTestBase
    {
        ...
        public async Task ValidateUnsupportedColumnTypeIsNotInferred()
        {
            ...
            // The narrowed path reads the shape without CommandBehavior.KeyInfo, so the reader
            // reports no auto-increment flag and it is carried from the catalog instead. Asserted
            // here because losing it would silently make creates require an identity value.
            Assert.IsTrue(
