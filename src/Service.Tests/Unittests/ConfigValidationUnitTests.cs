...
namespace Azure.DataApiBuilder.Service.Tests.UnitTests
{
    ...
    public class ConfigValidationUnitTests
    {
        ...
        /// </summary>
        [DataTestMethod]
        [DataRow(true, DisplayName = "Validate that exception is thrown when GQL is enabled and user defines multiple relationship between source and target entities.")]
