...
namespace Azure.DataApiBuilder.Service.Tests.UnitTests
{
    ...
    public class ODataASTVisitorUnitTests : SqlTestBase
    {
        ...
        [DataRow("string_types eq 'hello'", "([string_types] = CAST(@param1 AS VARCHAR(MAX)))", DisplayName = "Equate string types.")]
        [DataRow("nvarchar_string_types eq 'hello'", "([string_types] = @param1)", DisplayName = "Equate nvarchar string types.")]
