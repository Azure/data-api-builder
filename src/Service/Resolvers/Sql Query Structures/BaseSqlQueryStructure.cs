...
namespace Azure.DataApiBuilder.Service.Resolvers
{
    ...
    public abstract class BaseSqlQueryStructure : BaseQueryStructure
    {
        ...
        /// Adds result of (DatabaseEntityDefinition.Columns minus MutationFields) to UpdateOperations with null values
        ...
        /// <param name="dbEntityDefinition">The definition for the table.</param>
        ...
        {
            //result of adding (DatabaseEntityDefinition.Columns - MutationFields) to UpdateOperations
            foreach (string leftoverColumn in leftoverSchemaColumns)
            {
                ...
                if (dbEntityDefinition.Columns[leftoverColumn].IsAutoGenerated)
                {
                    continue;
                }
        ...
        {
            if (GetUnderlyingDbEntityDefinition().Columns.TryGetValue(columnName, out ColumnDefinition? column))
            {
        ...
        /// <summary>
        /// Returns the DatabaseEntityDefinition for the entity(table/view) of this query.
        /// </summary>
        protected DatabaseEntityDefinition GetUnderlyingDbEntityDefinition()
        {
        ...
        {
            return GetUnderlyingDbEntityDefinition().PrimaryKey;
        }
        ...
        {
            return GetUnderlyingDbEntityDefinition().Columns.Select(col => col.Key).ToList();
        }
        ...
        protected List<LabelledColumn> GenerateOutputColumns()
        {
            ...
            foreach (string columnName in GetUnderlyingDbEntityDefinition().Columns.Keys)
            {
