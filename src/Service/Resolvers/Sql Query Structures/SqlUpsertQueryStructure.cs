...
namespace Azure.DataApiBuilder.Service.Resolvers
{
    ...
    public class SqlUpsertQueryStructure : BaseSqlQueryStructure
    {
        ...
        : base(sqlMetadataProvider, entityName: entityName)
        {
            ...
            SetFallbackToUpdateOnAutogeneratedPk(GetUnderlyingBaseTableDefinition());
            ...
            bool isIncrementalUpdate)
        {
            ...
            foreach (string key in baseTableDefinition.Columns.Keys)
            {
                if (!tableDefinition.ColumnAliasesFromBaseTable.
                    TryGetValue(key, out string? field))
                {
                    field = key;
                }
                ...
                {
                    primaryKeysInBaseTable.Add(field);
                }
            }
            ...
            try
            {
                ...
                {
                    SetFallbackToUpdateOnMissingColumInPatch(schemaColumns, baseTableDefinition);
                }
                else
                {
