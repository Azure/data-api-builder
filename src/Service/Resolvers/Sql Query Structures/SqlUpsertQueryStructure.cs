            ...
            bool isIncrementalUpdate)
        {
            ...
            try
            {
                foreach (KeyValuePair<string, object?> param in mutationParams)
                {
                    ...
                    {
                        paramIdentifier = MakeParamWithValue(GetParamAsSystemType(param.Value.ToString()!, backingColumn!, GetColumnSystemType(backingColumn!)), backingColumn);
                    }
                    else
                    {
                        paramIdentifier = MakeParamWithValue(null, backingColumn);
                    }
