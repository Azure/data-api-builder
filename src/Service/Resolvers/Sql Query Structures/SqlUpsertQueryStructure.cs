...
namespace Azure.DataApiBuilder.Service.Resolvers
{
    ...
    public class SqlUpsertQueryStructure : BaseSqlQueryStructure
    {
        ...
        : base(sqlMetadataProvider, entityName: entityName)
        {
            ...
            SetFallbackToUpdateOnAutogeneratedPk(dbEntityDefinition);

            // Populates the UpsertQueryStructure with UPDATE and INSERT column:value metadata
            PopulateColumns(mutationParams, dbEntityDefinition, isIncrementalUpdate: incrementalUpdate);
            ...
            bool isIncrementalUpdate)
        {
            ...
            List<string> schemaColumns = dbEntityDefinition.Columns.Keys.ToList();
            ...
            try
            {
                ...
                {
                    SetFallbackToUpdateOnMissingColumInPatch(schemaColumns, dbEntityDefinition);
                }
                else
                {
                    // UpdateOperations will be modified and have nullable values added for update when appropriate
                    AddNullifiedUnspecifiedFields(schemaColumns, UpdateOperations, dbEntityDefinition);
                }
            }
        ...
        private void SetFallbackToUpdateOnAutogeneratedPk(DatabaseEntityDefinition tableDef)
        {
        ...
        /// </summary>
        /// <param name="tableDef"></param>
        private void SetFallbackToUpdateOnMissingColumInPatch(List<string> leftoverSchemaColumns, DatabaseEntityDefinition tableDef)
        {
