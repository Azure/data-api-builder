...
namespace Azure.DataApiBuilder.Service.Services
{
    ...
    public class RequestValidator
    {
        ...
        {
            DatabaseEntityDefinition dbEntityDefinition = sqlMetadataProvider.GetDbEntityDefinition(context.EntityName);
            ...
            ISqlMetadataProvider sqlMetadataProvider)
        {
            ...
            int countOfPrimaryKeysInSchema = dbEntityDefinition.PrimaryKey.Count;
            ...
            IEnumerable<string> missingKeys = primaryKeysInRequest.Except(dbEntityDefinition.PrimaryKey);
            ...
            ISqlMetadataProvider sqlMetadataProvider)
        {
            ...
            foreach (KeyValuePair<string, ColumnDefinition> column in dbEntityDefinition.Columns)
            {
                ...
                if (dbEntityDefinition.PrimaryKey.Contains(column.Key))
                {
                    continue;
                }
        ...
        private static DatabaseEntityDefinition TryGetDatabaseEntityDefinition(
            string entityName,
            ISqlMetadataProvider sqlMetadataProvider)
        {
            try
